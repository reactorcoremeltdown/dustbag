...
COLUMNS=`curl -s -u "jsonrpc:${PASSWORD}" -XPOST -H 'Content-Type: application/json' --data "{\"jsonrpc\": \"2.0\", \"method\": \"getColumns\", \"id\": ${COLUMNS_REQ_ID}, \"params\": [ 14 ] }" https://board.rcmd.space/jsonrpc.php`
