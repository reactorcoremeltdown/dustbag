...
hledger balance --depth 1 --weekly --begin=$(date --date="today - 3 weeks" "+%Y/%m/%d") | convert -font /usr/share/texmf/fonts/opentype/public/lm/lmsansquot8-regular.otf label:@- /home/ledger/expenses.png
