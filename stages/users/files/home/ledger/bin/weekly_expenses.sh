...
hledger balance --depth 1 --weekly --begin=$(date --date="today - 3 weeks" "+%Y/%m/%d") | convert -font /usr/share/fonts/truetype/dejavu/DejaVuSansMono.ttf -pointsize 24 -resize 1024x768 label:@- /home/ledger/expenses.png
