...
nginx_certificates:
	...
	test -L /etc/letsencrypt/live/rcmd.space/fullchain.pem || yes | certbot certonly --agree-tos --pre-hook "/bin/sleep 60" --non-interactive --email azer.abdullaev.berlin@gmail.com --dns-cloudflare --dns-cloudflare-credentials /root/.cloudflare.ini -d rcmd.space,*.rcmd.space --preferred-challenges dns-01
...
mpd:
	...
	install -D -m 644 -v stages/services/files/etc/systemd/system/mpdscribble.service.d/restart.conf /etc/systemd/system/mpdscribble.service.d
