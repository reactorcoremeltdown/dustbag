...
nginx_sites:
	...
	test -f /etc/nginx/sites-enabled/notifications.conf && rm -f /etc/nginx/sites-enabled/notifications.conf || true
	test -f /etc/nginx/sites-enabled/drone.conf && rm -f /etc/nginx/sites-enabled/drone.conf || true
	test -f /etc/nginx/sites-enabled/pics.conf && rm -f /etc/nginx/sites-enabled/pics.conf || true
	test -f /etc/nginx/sites-enabled/transmission.conf && rm -f /etc/nginx/sites-enabled/transmission.conf || true
