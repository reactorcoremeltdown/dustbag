...
nginx_certificates:
	...
	bash stages/services/includes/nginx/templates/hetzner.sh
	test -L /etc/letsencrypt/live/rcmd.space/fullchain.pem || yes | certbot certonly --agree-tos --non-interactive --authenticator dns-hetzner-cloud  --dns-hetzner-cloud-credentials /root/.hetzner.ini -d rcmd.space,*.rcmd.space
