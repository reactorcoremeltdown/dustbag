...
server {
    ...
    access_log /var/log/nginx/bank.rcmd.space_access.log json;
    error_log /var/log/nginx/bank.rcmd.space_error.log;
...
ln -sf /etc/nginx/sites-available/bank.conf /etc/nginx/sites-enabled/bank.conf
